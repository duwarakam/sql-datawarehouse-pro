...
SELECT
			...
			CASE 
				WHEN UPPER(TRIM(cst_marital_status)) = 'S' THEN 'Single' --using upper incase lowercase values r there
				WHEN UPPER(TRIM(cst_marital_status)) = 'M' THEN 'Married' -- trim used to catch unwanted spaces
				ELSE 'n/a'
